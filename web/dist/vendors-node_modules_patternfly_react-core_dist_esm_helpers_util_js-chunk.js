"use strict";
(self["webpackChunkmonitoring_plugin"] = self["webpackChunkmonitoring_plugin"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_helpers_util_js"],{
...
/* harmony export */   getInlineStartProperty: () => (/* binding */ getInlineStartProperty),
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "../node_modules/@patternfly/react-core/dist/esm/helpers/constants.js");
...
function sideElementIsOutOfView(container, element) {
    ...
    let side = _constants__WEBPACK_IMPORTED_MODULE_0__.SIDE.NONE;
    if (isOffRight && isOffLeft) {
        side = _constants__WEBPACK_IMPORTED_MODULE_0__.SIDE.BOTH;
    }
    else if (isOffRight) {
        side = _constants__WEBPACK_IMPORTED_MODULE_0__.SIDE.RIGHT;
    }
    else if (isOffLeft) {
        side = _constants__WEBPACK_IMPORTED_MODULE_0__.SIDE.LEFT;
    }
    // Return outcome
    return side;
}
...
const getVerticalBreakpoint = (height) => {
    ...
    if (height >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalHeightBreakpoints['2xl']) {
        return '2xl';
    }
    if (height >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalHeightBreakpoints.xl) {
        return 'xl';
    }
    if (height >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalHeightBreakpoints.lg) {
        return 'lg';
    }
    if (height >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalHeightBreakpoints.md) {
        return 'md';
    }
    if (height >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalHeightBreakpoints.sm) {
        return 'sm';
    }
    return 'default';
};
...
const getBreakpoint = (width) => {
    ...
    if (width >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalWidthBreakpoints['2xl']) {
        return '2xl';
    }
    if (width >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalWidthBreakpoints.xl) {
        return 'xl';
    }
    if (width >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalWidthBreakpoints.lg) {
        return 'lg';
    }
    if (width >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalWidthBreakpoints.md) {
        return 'md';
    }
    if (width >= _constants__WEBPACK_IMPORTED_MODULE_0__.globalWidthBreakpoints.sm) {
        return 'sm';
    }
    return 'default';
};
 ...
 */
const getReferenceElement = (refProp) => {
 ...
 */
const getInlineStartProperty = (targetElement, ancestorElement, inlineType = 'offset') => {
    if (!targetElement) {
        return;
    }
