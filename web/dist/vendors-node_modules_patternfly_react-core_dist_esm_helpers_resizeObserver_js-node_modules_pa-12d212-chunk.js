"use strict";
(self["webpackChunkmonitoring_plugin"] = self["webpackChunkmonitoring_plugin"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_helpers_resizeObserver_js-node_modules_pa-12d212"],{
...
function getInputFiles(evt) {
    return fromList(evt.target.files).map(file => (0,_file__WEBPACK_IMPORTED_MODULE_1__.toFileWithPath)(file));
}
// Ee expect each handle to be https://developer.mozilla.org/en-US/docs/Web/API/FileSystemFileHandle
function getFsHandleFiles(handles) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
        const files = yield Promise.all(handles.map(h => h.getFile()));
        return files.map(file => (0,_file__WEBPACK_IMPORTED_MODULE_1__.toFileWithPath)(file));
    });
}
function getDataTransferFiles(dt, type) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
        ...
        return noIgnoredFiles(fromList(dt.files)
            .map(file => (0,_file__WEBPACK_IMPORTED_MODULE_1__.toFileWithPath)(file)));
    });
}
    ...
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (globalThis.isSecureContext && typeof item.getAsFileSystemHandle === 'function') {
            ...
            if (h !== undefined) {
                ...
                file.handle = h;
                return (0,_file__WEBPACK_IMPORTED_MODULE_1__.toFileWithPath)(file);
            }
        }
        ...
        const fwp = (0,_file__WEBPACK_IMPORTED_MODULE_1__.toFileWithPath)(file, (_a = entry === null || entry === void 0 ? void 0 : entry.fullPath) !== null && _a !== void 0 ? _a : undefined);
        return fwp;
    });
}
...
function fromDirEntry(entry) {
    ...
    return new Promise((resolve, reject) => {
        ...
        function readEntries() {
            ...
            reader.readEntries((batch) => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
                if (!batch.length) {
...
function fromFileEntry(entry) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            entry.file((file) => {
                const fwp = (0,_file__WEBPACK_IMPORTED_MODULE_1__.toFileWithPath)(file, entry.fullPath);
                resolve(fwp);
            }, (err) => {
                reject(err);
            });
...
Dropzone.propTypes = {
   ...
   */
  accept: prop_types__WEBPACK_IMPORTED_MODULE_1___default().objectOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_1___default().string))),
   ...
   */
  onFileDialogOpen: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),

  /**
   * Set to true to use the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API
   * to open the file picker instead of using an `<input type="file">` click event.
   */
  useFsAccessApi: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
...
//# sourceMappingURL=vendors-node_modules_patternfly_react-core_dist_esm_helpers_resizeObserver_js-node_modules_pa-12d212-chunk.js.map